...
ELSE()
    IF(NOT ${MOBILITY_CONFIG_MKSPECS_FILE} STREQUAL "")
        ...
        IF(${MOBILITY_FILE_CONTENTS} MATCHES "MOBILITY_CONFIG=.*multimedia.*")
            SET(QT_MOBILITY_MULTIMEDIA_FOUND 1)
            IF(${QT_MOBILITY_VERSION} VERSION_EQUAL 1.0.0)
                SET(QT_MOBILITY_MULTIMEDIA_INCLUDE_DIR ${QT_MOBILITY_INCLUDE_DIR})
            ELSE()
                SET(QT_MOBILITY_MULTIMEDIA_INCLUDE_DIR ${QT_MOBILITY_INCLUDE_DIR}/QtMultimediaKit)
            ENDIF()
            SET(QT_MOBILITY_MULTIMEDIA_LIBRARY QtMultimediaKit)
        ENDIF()
    ENDIF()
ENDIF()
