...
enum PlaylistColumn { FileTypeColumn = 0, FileNameColumn, TitleColumn, ArtistColumn, AlbumColumn, DateColumn, GenreColumn, DescriptionColumn, TrackNumberColumn, DurationColumn };
